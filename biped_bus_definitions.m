...
elems(14).DataType = 'Bus: pd_bus';

elems(15) = Simulink.BusElement;
elems(15).Name = 'weight_ff';
elems(15).Dimensions = [1 11];
elems(15).DataType = 'Bus: feedforward_bus';

elems(16) = Simulink.BusElement;
elems(16).Name = 'energy_ff';
elems(16).Dimensions = [1 11];
elems(16).DataType = 'Bus: feedforward_bus';

elems(17) = Simulink.BusElement;
elems(17).Name = 'body_angle_pd';
elems(17).Dimensions = [1 11];
elems(17).DataType = 'Bus: pd_bus';
