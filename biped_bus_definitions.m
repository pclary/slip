...
make_bus(ControllerState, 'controller_state_bus', {'leg_controller_state_bus', 'leg_controller_state_bus'});
...
make_bus(ControllerParams, 'controller_params_bus', {'pd_bus', 'pd_bus', 'pd_bus'});
