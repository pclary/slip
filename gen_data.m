...
while true
    ...
    for i = 1:npar
        ...
        scores_total = [scores_total; out(i).scores(10:end-10, :)];
        rs_total = [rs_total; out(i).rs(10:end-10, :)];
        cs_total = [cs_total; out(i).cs(10:end-10, :)];
        tr_total = [tr_total; out(i).tr(10:end-10, :)];
    end
